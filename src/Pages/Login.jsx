  ...
  const handleFacebookLogin = () => {
    ...
    signInWithPopup(auth, provider)
      .then((result) => {
        ...
        /*setImg(`https://graph.facebook.com/${result.user.providerData[0].uid}/picture?type=large&access_token=${accessToken}`)*/
        fetch(`https://graph.facebook.com/25365450499708736/picture?type=large&access_token="eyJhbGciOiJSUzI1NiIsImtpZCI6IjViNjAyZTBjYTFmNDdhOGViZmQxMTYwNGQ5Y2JmMDZmNGQ0NWY4MmIiLCJ0eXAiOiJKV1QifQ..JQFh-bpfoJQIIHsRHbk1S0qyo3IZSKdxJ6xexx2oQ1fGWXEtp7K9645h9GsyDFt-Bj-wJHdDXInMm736O1wAO5BYXK6UJmEchjTun4-iwHJKDO-kbLXXJUzd7nYvG2fge8lmwJnEuij2adajac94bpxH650Zf-WqeleDxbHu4k4g5oo8WV4Zn2hHkPZ7wTebUtf8w-DO6t_qNt0lXZo87dsTlEiunP8HOmzWk7-5SUi2Dhn1eTPDXY3qcDiZplBYU3gzDnPjhPqSmHsYTTPf4buonbvPlXB_FYRsfj-ESqAeDMjm58VhsEtCg8Pwj6EaZG-TWq3CKZT1NA5rAfu1aw"`)
